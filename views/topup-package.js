...
if (khqrAuto && data.khqr && data.khqr.qr && window.QRCode) {
startKhqrPay(data.order.code, data.khqr, confirmUrl);
} else {
...
pollTimer = setTimeout(poll, 4000);
  ...
  const khqrHead = khqrAuto
    ...
    : '';
  return layout({ title: `${game.shortName} — បញ្ចូល — Wanfunzy`, body, head: turnstileHead + khqrHead });
}
